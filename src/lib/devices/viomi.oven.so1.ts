...
export default class extends Device {
  ...
  static image = "http://static.home.mi.com/app/image/get/file/developer_1559200234f6m0l1sk.png";
  ...
  setPause() {
    return this.miioCall("setPause", [1]);
  }

  setUnpause() {
    return this.miioCall("setPause", [0]);
  }
