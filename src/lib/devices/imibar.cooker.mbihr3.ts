...
const codeToNum = (str: string): number => {
  str = str.toString();
  const num = CODES.indexOf(str);
  return num > -1 ? num : 48;
};

const numtoCode = (num: number): string => {
  // num = parseInt(num, 10);
  return CODES[num] || "";
};
...
export default class extends Device {
  ...
  static image = "http://static.home.mi.com/app/image/get/file/developer_1548319397xzm4c2vv.png";
  ...
  getRemainingPTime(): number | undefined {
  ...
  getRemainingWarmTime(): number | undefined {
