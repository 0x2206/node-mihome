...
import aqaraProtocol from "./protocol-aqara";
import utils from "./utils";

export default class AqaraDevice extends EventEmitter {
  private id: string = null;
  private model: string = null;
  private sid: string = null;
  private parent: string = null;
  private refresh = refresh >= 0 || 30000;
  private _properties = {};

  constructor({ id, model, parent, refresh }: { id: string; model: string; parent: string; refresh: number }) {
    super();
