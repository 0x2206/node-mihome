...
import miioProtocol from "./protocol-miio";
import miCloudProtocol from "./protocol-micloud";
...
type Protocol = "local" | "cloud";

export default class MiioDevice extends EventEmitter {
  private id: string = null;
  private address: string = null;
  private token: string = null;
  private protocol: Protocol = "local";
  private refresh = 15000;

  private _properties = {};
  public _propertiesToMonitor: string[] = [];
  private _miotSpec = null;
  private _miotSpecType = null;
  ...
  async loadProperties(props?: any[]): Promise<void> {
    try {
  ...
  async miioCall(method, params, options: { refresh: boolean } = { refresh: false }) {
